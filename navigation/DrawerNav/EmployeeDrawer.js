    ...
    return (
      ...
      <View style={{flex: 1}}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            navigator('Employee_Login'), dispatch(authActions.logOut());
          }}>
          <View
            style={{
              flexDirection: 'row',
            ...
            <Icons
              name="logout"
              size={22}
              style={{color: COLORS.darkGray2, padding: 4}}
            />

            <Text style={{...FONTS.h4, textAlignVertical: 'center',color:COLORS.darkGray2}}>
              Logout
            </Text>
          </View>
        </TouchableOpacity>
  ...
  function DrawerIcons(props) {
    ...
    return (
      <TouchableOpacity
        ...
        />
        <Text
          style={{color: COLORS.darkGray2, textAlign: 'center', fontSize: 13}}>
          {header}
        </Text>
      </TouchableOpacity>
    );
