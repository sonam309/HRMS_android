      ...
      <View>
        ...
        <View>
          <View style={{borderBottomWidth: 1, borderBottomColor: COLORS.gray}}>
            <Text style={{fontSize: 16, color: COLORS.orange1, ...FONTS.h3}}>
              {' '}
              Categories{' '}
            </Text>
            ...
            <View
              ...
              <Pressable
                ...
                style={[
                  styles.filterCatBtn,
                  {
                    width: '48%',
                    borderColor:
                      selectedOption === '' ? COLORS.green : COLORS.gray,
                    borderWidth: selectedOption === '' ? 2 : 1.2,
                  },
                ]}>
                <Text
                  style={[
              ...
              <Pressable
                onPress={() => setSelectedOption('New Job Opening')}
                style={[
                  styles.filterCatBtn,
                  {
                    width: '48%',
                    borderColor:
                      selectedOption === 'New Job Opening'
                        ? COLORS.green
                        : COLORS.gray,
                    borderWidth: selectedOption === 'New Job Opening' ? 2 : 1.2,
                  },
                ]}>
                <Text
                  style={[
                    styles.filterCatTxt,
                    {
                      color:
                        selectedOption === 'New Job Opening'
                          ...
                          : COLORS.darkGray2,
                      fontWeight:
                        selectedOption === 'New Job Opening' ? '600' : '500',
                    },
                  ]}>
                  {' '}
                  New Job Opening{' '}
            ...
            <View
              ...
              <Pressable
                onPress={() => setSelectedOption('Salary Allocation')}
                style={[
                  styles.filterCatBtn,
                  {
                    width: '48%',
                    borderColor:
                      selectedOption === 'Salary Allocation'
                        ? COLORS.green
                        : COLORS.gray,
                    borderWidth:
                      selectedOption === 'Salary Allocation' ? 2 : 1.2,
                  },
                ]}>
                <Text
                  style={[
                    styles.filterCatTxt,
                    {
                      color:
                        selectedOption === 'Salary Allocation'
                          ...
                          : COLORS.darkGray2,
                      fontWeight:
                        selectedOption === 'Salary Allocation' ? '600' : '500',
                    },
                  ]}>
                  {' '}
                  Salary Allocation{' '}
              ...
              <Pressable
                onPress={() => setSelectedOption('New Job Request')}
                style={[
                  styles.filterCatBtn,
                  {
                    width: '48%',
                    borderColor:
                      selectedOption === 'New Job Request'
                        ? COLORS.green
                        : COLORS.gray,
                    borderWidth: selectedOption === 'New Job Request' ? 2 : 1.2,
                  },
                ]}>
                <Text
                  style={[
                    styles.filterCatTxt,
                    {
                      color:
                        selectedOption === 'New Job Request'
                          ...
                          : COLORS.darkGray2,
                      fontWeight:
                        selectedOption === 'New Job Request' ? '600' : '500',
                    },
                  ]}>
                  {' '}
                  New Job Request{' '}
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() => (setNotificationCat(''), setSelectedOption(''))}
