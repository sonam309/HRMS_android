...
const Otp_Verification = (props) => {
    ...
    const forgetPasswordApi = () => {
        ...
        axios.get('https://econnectsatya.com:7033/api/GetMobileNo', {
            ...
            // result[0] === "S" ? (props.navigation.navigate("Otp_Verification", { contact,otp}))
    ...
    return (
        ...
        <View style={{ backgroundColor: 'white', flex: 1, flexDirection: 'column' }}>
            ...
            <View style={{
                ...
                <Text style={{ color: '#474E68', fontWeight: 300, fontSize: 12 }}>
            ...
            <View style={{
                ...
                <TextInput ref={et1} style={[style.inputView, { borderColor: f1.length >= 1 ? '#F99417' : '#000' }]}
                ...
                <TextInput ref={et2} style={[style.inputView, { borderColor: f2.length >= 1 ? '#F99417' : '#000' }]}
                    keyboardType="number-pad"
                    maxLength={1}
                    value={f2}
                    onChangeText={txt => {
                ...
                <TextInput ref={et3} style={[style.inputView, { borderColor: f3.length >= 1 ? '#F99417' : '#000' }]}
                    keyboardType="number-pad"
                ...
                <TextInput ref={et4} style={[style.inputView, { borderColor: f4.length >= 1 ? '#F99417' : '#000' }]}
                    keyboardType="number-pad"
                ...
                <TextInput ref={et5} style={[style.inputView, { borderColor: f5.length >= 1 ? '#F99417' : '#000' }]}
                    keyboardType="number-pad"
                    maxLength={1} value={f5}
                    onChangeText={txt => {
                        setF5(txt)
                        if (txt.length >= 1) {
                            et6.current.focus();
                ...
                <TextInput ref={et6} style={[style.inputView, { borderColor: f6.length >= 1 ? '#F99417' : '#000' }]}
                    keyboardType="number-pad"
                    maxLength={1} value={f6}
                    onChangeText={txt => {
                        setF6(txt)
                        if (txt.length >= 1) {
            ...
            <View style={style.resendView}>
                <Text style={{
                    fontSize: 15, fontWeight: '400', color: count == 0 ?
                        '#03a157' : "#9D9D9D"
                }}
                    onPress={() => { setCount(60); forgetPasswordApi() }}
                >Resend</Text>
                {count !== 0 && (
                    <Text style={{ marginLeft: 5, fontSize: 15 }}> {count + ' seconds'} </Text>
                )}
