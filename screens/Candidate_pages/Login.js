...
const Login = props => {
  ...
  const [userId, setUserId] = useState('725');
        ...
        .then(response => {
          ...
          if (returnedData.FLAG === 'S') {
            ...
            if (returnedData?.SATHI_VERSION > VERSIONS?.android) {
              ...
              (props.navigation.navigate('Candidate_page'),
                dispatch(
        ...
        <Modal
          ...
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              ...
              <View style={{ height: '100%', alignSelf: 'center', width: '100%', marginTop: -20 }}>
                <Image source={company_logo_2} style={{ height: 120, width: 120, marginLeft: 60 }}
                />
                <Text style={{ ...FONTS.body5, lineHeight: 16, marginTop: -30, textAlign: 'center' }}>
                  You are currently using older version of this APK, update now and continue.
                </Text>
                <Text style={{ marginTop: 10, ...FONTS.body5, textAlign: 'center', color: COLORS.lighterVoilet }}>
                  Older Version: {VERSIONS?.olderVersion}
                </Text>
                <Text style={{ ...FONTS.h5, textAlign: 'center', color: COLORS.lighterVoilet }}>
                ...
                <TextButton
                  ...
                  onPress={() => Linking.openURL('https://play.google.com/store/apps/details?id=com.koshishapp')}
