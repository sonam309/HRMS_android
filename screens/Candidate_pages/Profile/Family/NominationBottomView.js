    ...
    return (
      <View
        ...
        <Text style={{fontWeight: 600}}>
          Nomination Type:-{' '}
          <Text style={{fontWeight: 400}}>{item.NOMINATION_TYPE}</Text>
        </Text>
        <Text style={{fontWeight: 600}}>
          Family Member:-{' '}
          <Text style={{fontWeight: 400}}>{item.FAMILY_MEMBER}</Text>
        </Text>
        <Text style={{fontWeight: 600}}>
          Gaurdian Name:-{' '}
          <Text style={{fontWeight: 400}}>{item.GUARDIAN_NAME}</Text>
        </Text>
        <Text style={{fontWeight: 600}}>
          Share %:- <Text style={{fontWeight: 400}}>{item.SHARE}</Text>
        </Text>
      </View>
    );
  };
  ...
  const NomineeDetails = () => {
    return (
      <View style={{padding: 4, marginVertical: 5}}>
        ...
        {allNominee.map((item, index) => (
          <Nominee item={item} key={index} />
        ))}
      </View>
    );
  };
                  ...
                  onChangeText={
                    share <= 100
                      ...
                      : [
                          showAlert({
                            title:
                              'You can not distribute more than 100 shares',
                            customIcon: 'none',
                            message: '',
                            alertType: 'error',
                            onPress: () => closeAlert(),
