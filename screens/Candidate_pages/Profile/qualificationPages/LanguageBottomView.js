  ...
  const checkLanguageValue = value => {
    {
      for (let index = 0; index < language.length; index++) {
        ...
        if (element.PARAM_NAME === value)
          setSelectedLanguageValue(element.PARAM_ID);
      }
    }
  };
      ...
      <View
        ...
        <Text style={{fontWeight: 600}}>
          ...
          <Text style={{fontWeight: 400}}>
            {item.CAN_READ === 'true' ? 'Yes' : 'No'}
          </Text>
        </Text>
        <Text style={{fontWeight: 600}}>
          Can Speak:-{' '}
          <Text style={{fontWeight: 400}}>
            {item.CAN_SPEAK === 'true' ? 'Yes' : 'No'}
          </Text>
        </Text>
        <Text style={{fontWeight: 600}}>
          Can Write:-{' '}
          <Text style={{fontWeight: 400}}>
            {item.CAN_WRITE === 'true' ? 'Yes' : 'No'}
          </Text>
        </Text>
        <Text style={{fontWeight: 600}}>
          Mother Tongue:-{' '}
          <Text style={{fontWeight: 400}}>
            {item.MOTHER_TONGUE === 'true' ? 'Yes' : 'No'}
          </Text>
        </Text>
      </View>
    );
      ...
      {!showForm && languages[0].TXN_ID && languages.length > 0 ? (
        ...
        <View>
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() =>
                setIsMothertongue(isMothertongue === 'true' ? 'false' : 'true')
              }
              style={{
                alignItems: 'center',
                width: '39%',
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() =>
                setIsCanRead(isCanRead === 'true' ? 'false' : 'true')
              }
              style={{
                alignItems: 'center',
                width: '32%',
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() =>
                setIsCanWrite(isCanWrite === 'true' ? 'false' : 'true')
              }
              style={{
                alignItems: 'center',
                width: '32%',
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() =>
                setIsCanSpeak(isCanSpeak === 'true' ? 'false' : 'true')
              }
              style={{
                alignItems: 'center',
                width: '34%',
          ...
          {approvalFlag !== 'A' ? (
            <TouchableOpacity onPress={() => saveLanguageDetails()}>
              <LinearGradient
                ...
                style={{borderRadius: 8, padding: 8, marginTop: 30}}>
                <Text
                  style={{
                    color: COLORS.white,
                    textAlign: 'center',
