    ...
    <ScrollView showsVerticalScrollIndicator={false}>
      <View style={{marginBottom: 320}}>
        ...
        <View style={{flex: 1, flexDirection: 'row', marginBottom: 10}}>
          <Text
            style={{flex: 1, ...FONTS.h4, fontSize: 20, color: COLORS.orange}}>
            Training
          </Text>
          <View
            style={{
        ...
        <View style={{height: 75}}>
          ...
          <SelectDropdown
            data={Qualifications?.map(a => a.PARAM_NAME)}
            buttonStyle={[styles.inputHolder]}
            onSelect={value => {
              setSelectQualifications(value), checkQualificationsValue(value);
            }}
            defaultButtonText={selectedDropDownText('qualification')}
            defaultValueByIndex={selectDropDownValue('qualification')}
        ...
        <View style={{height: 75, marginTop: 10}}>
          ...
          <SelectDropdown
            data={stream?.map(a => a.PARAM_NAME)}
            buttonStyle={[styles.inputHolder]}
            onSelect={value => {
              setSelectedStream(value), checkStreamValue(value);
            }}
            defaultButtonText={selectedDropDownText('Stream')}
            defaultValueByIndex={selectDropDownValue('Stream')}
            buttonTextStyle={{fontSize: 15, color: COLORS.gray}}
          />
        </View>
        ...
        <View style={{height: 75, marginTop: 10}}>
          ...
          <SelectDropdown
            data={qualificationMode?.map(a => a.PARAM_NAME)}
            buttonStyle={[styles.inputHolder]}
            onSelect={value => {
              setSelectedQualiMode(value), checkQualificationsModeValue(value);
            }}
            defaultButtonText={selectedDropDownText('QualificationMode')}
            defaultValueByIndex={selectDropDownValue('QualificationMode')}
            buttonTextStyle={{fontSize: 15, color: COLORS.gray}}
          />
        </View>
        {/* Country dropdown */}
        <View style={{height: 75, marginTop: 10}}>
          ...
          <SelectDropdown
            data={country?.map(a => a.PARAM_NAME)}
            buttonStyle={[styles.inputHolder]}
            onSelect={value => {
              setselectCountry(value), checkCountryValue(value);
            }}
            defaultButtonText={selectedDropDownText('country')}
            defaultValueByIndex={selectDropDownValue('country')}
            buttonTextStyle={{fontSize: 15, color: COLORS.gray}}
          />
        </View>
        {/* State dropdown */}
        <View style={{height: 75, marginTop: 10}}>
          ...
          <SelectDropdown
            ...
            defaultButtonText={selectedDropDownText('state')}
            defaultValueByIndex={selectDropDownValue('state')}
            buttonTextStyle={{fontSize: 15, color: COLORS.gray}}
          />
        </View>
        {/* City dropdown */}
