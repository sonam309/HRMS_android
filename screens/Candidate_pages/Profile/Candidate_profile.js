...
const Candidate_profile = () => {
  ...
  const [identificationApproveFlag, setIdentificationApproveFlag] =
    useState('');
  ...
  const getGuarantorDetails = () => {
    try {
      ...
      axios
        .post(`${API}/api/hrms/saveGrantorInfo`, guarantorData)
        .then(response => {
      ...
      launchCamera(options, res => {
        if (res.didCancel) {
          ...
          formData.append('fileUpload', {
            name: `profilePicDoc_${userId}_${getFormattedTimestamp()}.${
              res.assets[0].type.split('/')[1]
            }`,
            type: res.assets[0].type,
            uri: res.assets[0].uri,
          });
          fetch(`${API2}api/hrms/profilePic`, {
            method: 'POST',
            body: formData,
          })
            .then(res => {
  ...
  const getProfilePic = () => {
    ...
    formData.append('data', JSON.stringify(profilePicData));
    axios
      .post(`${API2}api/hrms/profilePic`, formData)
      .then(res => {
        console.log(res);
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View
          ...
          <TouchableOpacity onPress={selectProfilePic}>
            <Image
              source={{uri: `${API2}/ProfilePic/${profilePic}`}}
        ...
        <View
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => setAboutMeView(!aboutMeView)}
              ...
              <FontAwesome
                ...
                name={aboutMeView ? 'angle-up' : 'angle-down'}
                size={20}
                color={COLORS.orange}
              />
            </TouchableOpacity>
              ...
              <View style={{paddingHorizontal: 16, marginVertical: SIZES.base}}>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <TouchableOpacity
                    ...
                    onPress={() => setPersonalView(!personalView)}>
                    ...
                    <Text
                      style={{
                        ...
                        ...FONTS.body4,
                        color:
                          personalApprovalFlag === 'R'
                            ? COLORS.red
                            : personalApprovalFlag === 'A'
                            ? COLORS.green
                            : COLORS.gray,
                      }}>
                      Personal Details
                  ...
                  {personalApprovalFlag && (
                    <Image
                      source={
                        personalApprovalFlag === 'A'
                          ? approveMark
                          : personalApprovalFlag === 'R' && rejectMark
                      }
                      style={{
                        height: 20,
                        width: 20,
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <TouchableOpacity
                    ...
                    onPress={() => setContactView(!contactView)}>
              ...
              <View style={{paddingHorizontal: 16, paddingVertical: 8}}>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      setPersonalAddressView(!personalAddressView)
                    }>
          ...
          {personalAddressView && (
            <BottomUpModal
              isVisible={personalAddressView}
              onClose={() => {
                setPersonalAddressView(false);
              }}>
              <PersonalAddressBottomView
                onPress={() => setPersonalAddressView(false)}
              />
            </BottomUpModal>
          )}
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => setFamilyView(!familyView)}
              style={{flexDirection: 'row', padding: 5, alignItems: 'center'}}>
              <Icons
              ...
              <FontAwesome
                style={{position: 'absolute', right: 5}}
                name={familyView ? 'angle-up' : 'angle-down'}
                size={20}
                color={COLORS.orange}
              />
            </TouchableOpacity>
              ...
              <View style={{paddingHorizontal: 16, marginVertical: SIZES.base}}>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <TouchableOpacity
                    ...
                    onPress={() => setFamilyDetailsView(!familyDetailsView)}>
                    <MaterialIcons
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <TouchableOpacity
                    ...
                    onPress={() => setNominationView(!nominationView)}>
                  ...
                  {nominationAppFlag && (
                    <Image
                      source={
                        nominationAppFlag === 'A'
                          ? approveMark
                          : nominationAppFlag === 'R' && rejectMark
                      }
                      style={{
                        height: 20,
                        width: 20,
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <TouchableOpacity
                    ...
                    onPress={() => setMedicalView(!medicalView)}>
                    <FontAwesome5
                      name="clinic-medical"
                      color={'green'}
                      size={16}
          ...
          {familyDetailsView && (
            <BottomUpModal
              isVisible={familyDetailsView}
              onClose={() => {
                setFamilyDetailsView(false);
              }}>
              <FamilyBottomView
                members={members}
                ...
                onPress={() => setFamilyDetailsView(false)}
          ...
          {nominationView && (
            <BottomUpModal
              isVisible={nominationView}
              onClose={() => {
                setNominationView(false);
              }}>
          ...
          {medicalView && (
            <BottomUpModal
              isVisible={medicalView}
              onClose={() => {
                setMedicalView(false);
              }}>
              <MedicalBottomView
                medicalPolicy={medicalPolicy}
                setMedicalPolicy={setMedicalPolicy}
                onPress={() => setMedicalView(false)}
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => setSkillAndQualifView(!skillAndQualifView)}
              style={{flexDirection: 'row', padding: 5, alignItems: 'center'}}>
              <FontAwesome
                name="graduation-cap"
                size={16}
                color={COLORS.orange}
              />
              <Text style={{...FONTS.h4, paddingHorizontal: 5}}>
                Skills & Qualification
              </Text>
              <FontAwesome
                style={{position: 'absolute', right: 5}}
                name={skillAndQualifView ? 'angle-up' : 'angle-down'}
                size={20}
                color={COLORS.orange}
              />
            </TouchableOpacity>
              ...
              <View style={{paddingHorizontal: 16, marginVertical: SIZES.base}}>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <TouchableOpacity
                    ...
                    onPress={() => setQualificationsView(!qualificationsView)}>
                    <Icons
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <TouchableOpacity
                    ...
                    onPress={() => setSkillsView(!skillsView)}>
              ...
              <Text style={{ padding: 4, width: '100%', ...FONTS.body4 }}>Training</Text>
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <TouchableOpacity
                    ...
                    onPress={() => setLanguagesView(!languagesView)}>
          ...
          {qualificationsView && (
            <BottomUpModal
              ...
              {
                <QualificationBottomView
                  onPress={() => setQualificationsView(false)}
          ...
          {skillsView && (
            <BottomUpModal
              isVisible={skillsView}
              onClose={() => {
                setSkillsView(false);
              }}>
              {
                <SkillsBottomView
                  onPress={() => setSkillsView(false)}
                  skills={skills}
          ...
          {languagesView && (
            <BottomUpModal
              ...
              {
                <LanguageBottomView
                  onPress={() => setLanguagesView(false)}
                  languages={languages}
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => setIdentityView(!identityView)}
              style={{flexDirection: 'row', padding: 5, alignItems: 'center'}}>
              <Icons
              ...
              <FontAwesome
                style={{position: 'absolute', right: 5}}
                name={identityView ? 'angle-up' : 'angle-down'}
                size={20}
                color={COLORS.orange}
              />
            </TouchableOpacity>
              ...
              <View style={{paddingHorizontal: 16, marginVertical: SIZES.base}}>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <TouchableOpacity
                    ...
                    onPress={() => setIdentifications(!identifications)}>
                    <FontAwesome
                      name="vcard-o"
                      color={COLORS.green}
                      size={18}
                    ...
                    <Text
                      style={{
                        ...
                        ...FONTS.body4,
                        color:
                          identificationApproveFlag === 'R'
                            ? COLORS.red
                            : identificationApproveFlag === 'A'
                            ? COLORS.green
                            : COLORS.gray,
                      }}>
                      {' '}
                  ...
                  {identificationApproveFlag && (
                    <Image
                      source={
                        identificationApproveFlag === 'A'
                          ? approveMark
                          : identificationApproveFlag === 'R' && rejectMark
                      }
                      style={{
                        height: 20,
                        width: 20,
          ...
          {identifications && (
            <BottomUpModal
              ...
              }}>
              {
                <Identifications
                  isVisible={identifications}
                  onPress={() => setIdentifications(false)}
                />
              }
            </BottomUpModal>
          )}
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => setEmploymentView(!employmentView)}
              style={{flexDirection: 'row', padding: 5, alignItems: 'center'}}>
              ...
              <FontAwesome
                style={{position: 'absolute', right: 5}}
                name={employmentView ? 'angle-up' : 'angle-down'}
                size={20}
                color={COLORS.orange}
              />
            </TouchableOpacity>
              ...
              <View style={{paddingHorizontal: 16, marginVertical: SIZES.base}}>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <TouchableOpacity
                    ...
                    onPress={() => setEmployeHistoryView(!identifications)}>
                    <Icons
                  ...
                  {employmentAppFlag && (
                    <Image
                      source={
                        employmentAppFlag === 'A'
                          ? approveMark
                          : employmentAppFlag === 'R' && rejectMark
                      }
                      style={{
                        height: 20,
                        width: 20,
          ...
          {employHistoryView && (
            <BottomUpModal
              isVisible={employHistoryView}
              onClose={() => {
                setEmployeHistoryView(false);
              }}>
              {
                <Emp_HistoryBottomView
                  fetchEmploymentData={fetchEmploymentData}
                  onPress={() => setEmployeHistoryView(false)}
                  employment={employment}
                  setEmployement={setEmployement}
                />
              }
            </BottomUpModal>
          )}
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => setEsignView(!esignView)}
              style={{flexDirection: 'row', padding: 5, alignItems: 'center'}}>
              <Icons name="account-check" size={20} color={COLORS.orange} />
              <Text style={{...FONTS.h4, paddingHorizontal: 5}}>
                Guarantor Details for Indemnity bond
              </Text>
              <FontAwesome
                style={{position: 'absolute', right: 5}}
                name={esignView ? 'angle-up' : 'angle-down'}
                size={20}
                color={COLORS.orange}
              />
            </TouchableOpacity>
            {esignView && (
              <View
                style={{
                  ...
                  marginVesaveGrantorInfortical: SIZES.base,
                }}>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <TouchableOpacity
                    style={{
                    ...
                    onPress={() => setGuarantorView(!guarantorView)}>
                    <Icons
                      name="account-check"
                      color={COLORS.green}
                      size={18}
          ...
          {guarantorView && (
            <BottomUpModal
              isVisible={guarantorView}
              onClose={() => {
                setGuarantorView(false);
              }}>
