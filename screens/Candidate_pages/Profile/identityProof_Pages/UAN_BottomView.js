  ...
  const getData = () => {
    ...
    axios
      ...
      .then(response => {
        ...
        Object.keys(UANDetails).length > 2
          ? setOperFlag('E')
          : setOperFlag('U');
        ...
        <KeyboardAwareScrollView
          ...
          <View>
            ...
            <View style={{height: 75, marginTop: 10}}>
              ...
              <SelectDropdown
                defaultValue={selectedEarlierEps}
                data={EarlierEps}
                buttonStyle={[styles.inputHolder]}
                onSelect={(selectedItem, index) => {
                  setSelectedEarlierEps(selectedItem);
                }}
            ...
            <View style={{height: 75, marginTop: 10}}>
              ...
              <SelectDropdown
                defaultValue={selecedMemberEps1995}
                data={MemberEps1995}
                buttonStyle={[styles.inputHolder]}
                onSelect={(selectedItem, index) => {
                  setSelectedMemberEps1995(selectedItem);
                }}
                defaultButtonText={'Select'}
                buttonTextStyle={{fontSize: 15, color: COLORS.gray}}
              />
            ...
            <View style={{height: 75, marginTop: 10}}>
              ...
              <TextInput
                ...
                placeholder="Name"
                onChangeText={setPriviousAccNumber}
                value={priviousAccNumber}
                keyboardType="number-pad"
              />
            </View>
            {/* Previous UAN */}
              ...
              <TouchableOpacity onPress={() => saveUANDetails()}>
                <LinearGradient
                  ...
                  <Text
                    ...
                    {Object.keys(edit).length > 2 ? 'Update' : 'Save'}{' '}
                  </Text>
                </LinearGradient>
              </TouchableOpacity>
            )}
