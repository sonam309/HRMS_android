      ...
      {loaderVisible ? (
        ...
        <KeyboardAwareScrollView
          ...
          <View style={{height: 75, marginTop: 10}}>
            <Text style={{color: COLORS.green, ...FONTS.body4}}>
              {' '}
              Family Residing with you
            </Text>

            <SelectDropdown
              defaultValue={residingWithYou}
              data={residenceWithYou}
              buttonStyle={[styles.inputHolder]}
              onSelect={(selectedItem, index) => {
                setResidingWithYou(selectedItem);
              }}
          ...
          <View style={{height: 75, marginTop: 10}}>
            ...
            <TextInput
              ...
              value={noStatePlaceResidence}
              onChangeText={setNoStatePlaceResidence}
            />
          </View>
          ...
          <View style={{height: 75, marginTop: 10}}>
            ...
            <TextInput
              ...
              onChangeText={setPriInsuranceNum}
              value={priInsuranceNum}
              keyboardType="numeric"
            />
          </View>
          ...
          {approvalFlag !== 'A' ? (
            <TouchableOpacity
              onPress={() =>
                isEdit ? saveESICDetails('G') : saveESICDetails('C')
              }>
              <LinearGradient
