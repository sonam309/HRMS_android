...
const PersonalAddressBottomView = () => {
    ...
    return (
        <ScrollView style={{ height: '100%' }}>
            ...
            <Text style={{ color: 'green', paddingHorizontal: 6, paddingVertical: 3 }}>Present District</Text>
            <TextInput style={[styles.inputHolder, { marginVertical: 3, marginHorizontal: 7 }]} />

            <Text style={{ color: 'green', paddingHorizontal: 6, paddingVertical: 3 }}>Present Post Office</Text>
            <TextInput style={[styles.inputHolder, { marginVertical: 3, marginHorizontal: 7 }]} />

            <Text style={{ color: 'green', paddingHorizontal: 6, paddingVertical: 3 }}>Present Sub Division</Text>
            <TextInput style={[styles.inputHolder, { marginVertical: 3, marginHorizontal: 7 }]} />

            <Text style={{ color: 'green', paddingHorizontal: 6, paddingVertical: 3 }}>Present Thana</Text>
            <TextInput style={[styles.inputHolder, { marginVertical: 3, marginHorizontal: 7 }]} />
