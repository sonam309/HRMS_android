...
const PersonalAddressBottomView = ({ filledDetails }) => {
    ...
    const DisplayPreviousDetails = () => {
        ...
        setPresentPinCode(filledDetails);
        ...
        setPermanentPostOffice(filledDetails);

        setPermanentCity(filledDetails?.PERMANENT_CITY);
        setPermanentPinCode(filledDetails);
