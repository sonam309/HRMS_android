...
const PersonalAddressBottomView = ({onPress}) => {
  ...
  const [presentSelectedCountryValue, setPresentSelectedCountryValue] =
    useState();
  ...
  const [permanentSelectedStateValue, setPermanentSelectedStateValue] =
    useState();

  // permanent selected country
  const [permanentSelectedCountry, setPermanentSelectedCountry] = useState();
  const [permanentSelectedCountryValue, setPermanentSelectedCountryValue] =
    useState();

  // permanent address
  const [permanentAddressHeight, setPermanentAddressHeight] = useState(40);
  const [permanentPostOfficeHeight, setPermanentPostOfficeHeight] =
    useState(40);
  ...
  const [permanentSubDivisionEdit, setPermanentSubDivisionEdit] =
    useState(true);
    ...
    if (ValidateForm()) {
      ...
      try {
        ...
        let AddressData = {
          ...
          country: 'India',
          state: presentSelectedStateValue,
          city: presentCity,
          pincode: presentPinCode,
          district: presentDistrict,
          postOffice: presentPostOffice,
          subDivison: presentSubDivision,
          thana: presentThana,
          peramanentAddress: permanentAddress,
          permanentCountry: 'India',
          permanentState: permanentSelectedStateValue,
  ...
  const checkPresentCountry = value => {
    for (let index = 0; index < country.length; index++) {
      ...
      if (element.PARAM_NAME === value)
        setPresentSelectedCountryValue(element.PARAM_ID);
    }
  };
  ...
  const checkPresentState = value => {
    for (let index = 0; index < states.length; index++) {
      ...
      if (element.PARAM_NAME === value)
        setPresentSelectedStateValue(element.PARAM_ID);
    }
  };
  ...
  const checkPermanentCountry = value => {
    for (let index = 0; index < country.length; index++) {
      const element = country[index];
      if (element.PARAM_NAME === value)
        setPermanentSelectedCountryValue(element.PARAM_ID);
    }
  };
  ...
  const checkPermanentState = value => {
    for (let index = 0; index < states.length; index++) {
      const element = states[index];
      if (element.PARAM_NAME === value)
        setPermanentSelectedStateValue(element.PARAM_ID);
    }
  };

  const selectDropDownValue = id => {
    if (id === 'presentstates') {
      return presentSelectedStateValue
        ? presentSelectedStateValue
        : states?.map(a => a.PARAM_ID)[0];
    } else if (id === 'presentcountry') {
      return presentSelectedCountryValue
        ? presentSelectedCountryValue
        : country?.map(a => a.PARAM_ID)[0];
    } else if (id === 'permanentstate') {
      return permanentSelectedStateValue
        ? permanentSelectedStateValue
        : states?.map(a => a.PARAM_ID)[0];
    }
    return permanentSelectedCountryValue
      ? permanentSelectedCountryValue
      : country?.map(a => a.PARAM_ID)[0];
  };
  ...
  const selectDropDownText = id => {
    if (id === 'presentstates') {
      return presentSelectedState
        ? presentSelectedState
        : states?.map(a => a.PARAM_NAME)[0];
    } else if (id === 'presentcountry') {
      return presentSelectedCountry
        ? presentSelectedCountry
        : country?.map(a => a.PARAM_NAME)[0];
    } else if (id === 'permanentstate') {
      return permanentSelectedState
        ? permanentSelectedState
        : states?.map(a => a.PARAM_NAME)[0];
    }
    return permanentSelectedCountry
      ...
      {loaderVisible ? (
        ...
        <KeyboardAwareScrollView
          ...
          <TextInput
            style={[
              styles.inputHolder,
              {
                marginVertical: 3,
                marginHorizontal: 7,
                height: presentAddressHeight,
              },
            ]}
            multiline={true}
            onContentSizeChange={event => {
              setPresentAddressHeight(event.nativeEvent.contentSize.height);
            }}
            value={presentAddress}
            onChangeText={val => setPresentAddress(val)}
          />
          ...
          <TextInput
            ...
            onChangeText={val => setPresentPinCode(val)}
          ...
          <TextInput
            ...
            onChangeText={val => setPresentDistrict(val)}
          />
          ...
          <TextInput
            ...
            value={presentCity}
            onChangeText={val => setPresentCity(val)}
          />
          ...
          <TextInput
            ...
            onChangeText={val => setPresentPostOffice(val)}
            multiline={true}
            onContentSizeChange={event => {
              setPresentPostOfficeHeight(event.nativeEvent.contentSize.height);
            }}
          />
          ...
          <TextInput
            ...
            value={presentSubDivision}
            onChangeText={val => setPresentSubDivision(val)}
          />
          ...
          <TextInput
            ...
            value={presentThana}
            onChangeText={val => setPresentThana(val)}
          />
          ...
          <View style={{flexDirection: 'row', paddingHorizontal: 6}}>
            <Text style={{paddingHorizontal: 5}}>
              Is Permanent same as Present?
            </Text>
            <TouchableOpacity
              onPress={() => {
                sameAddress ? saveDifferentDetails() : saveSameDetails();
              }}>
              {sameAddress ? (
                <Icon
          ...
          <TextInput
            ...
            multiline={true}
            onContentSizeChange={event => {
              setPermanentAddressHeight(event.nativeEvent.contentSize.height);
            }}
            editable={permanentAddressEdit}
          />
          ...
          <TextInput
            ...
            onChangeText={val => setPermanentPinCode(val)}
            editable={permanentPinCodeEdit}
            keyboardType="numeric"
            maxLength={6}
          />
          ...
          <TextInput
            ...
            onChangeText={val => setPermanentDistrict(val)}
            editable={permanentDistrictEdit}
          />
          ...
          <TextInput
            ...
            value={permanentCity}
            onChangeText={val => setPermanentCity(val)}
            editable={permanentCityEdit}
          />
          ...
          <TextInput
            ...
            onChangeText={val => setPermanentPostOffice(val)}
            multiline={true}
            onContentSizeChange={event => {
              setPermanentPostOfficeHeight(
            ...
            editable={permanentPostOfficeEdit}
          />
          ...
          <TextInput
            ...
            value={permanentSubDivision}
            onChangeText={val => setPermanentSubDivision(val)}
            editable={permanentSubDivisionEdit}
          />
          ...
          <TextInput
            ...
            onChangeText={val => setPermanentThana(val)}
            editable={permanentThanaEdit}
          />
