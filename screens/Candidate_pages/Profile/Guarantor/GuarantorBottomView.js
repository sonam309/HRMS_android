      ...
      axios
        ...
        .then(response => {
          ...
          if (
            ...
            result[0]?.FIRST_GURANTR_AADHAR_NO != null
          ) {
            setIsDisabled(true);
          }
        });
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <View style={{flexDirection: 'row', marginBottom: 10}}>
        <Text style={{...FONTS.h4, fontSize: 18, color: COLORS.orange}}>
          Guarantor Details
        </Text>
        {approvalFlag === 'R' ? (
          <TouchableOpacity
      ...
      {loaderVisible ? (
        ...
        <KeyboardAwareScrollView
          ...
          <View
            ...
            <Text style={{color: COLORS.orange1, ...FONTS.h2, fontSize: 16}}>
              First Guarantor
            </Text>
            ...
            <View style={{marginTop: 10}}>
              ...
              <TextInput
                ...
                placeholder="Name"
                onChangeText={setFirstGuarantorName}
            ...
            <View style={{marginTop: 10}}>
              ...
              <TextInput
                ...
                placeholder=""
                onChangeText={setFirstGrantorCareOfName}
                value={firstGrantorCareOfName}
              />
            </View>
            {/* guarantor realtion */}
            <View style={{marginTop: 10}}>
              <Text style={{color: COLORS.green, ...FONTS.body4}}>
                First Guarantor Relation{' '}
                <Text
                  style={{
                    color: COLORS.red,
                    ...FONTS.h4,
              ...
              <TextInput
                ...
                placeholder=""
                onChangeText={setFirstGrantorRelation}
                value={firstGrantorRelation}
              />
            </View>
            {/* guarantor Aadhar */}
            <View style={{marginTop: 10}}>
              <Text style={{color: COLORS.green, ...FONTS.body4}}>
                First Guarantor Aadhar Number{' '}
                <Text
                  style={{
                    color: COLORS.red,
                    ...FONTS.h4,
              ...
              <TextInput
                ...
                onChangeText={setFirstGrantorAadhaarNo}
                value={firstGrantorAadhaarNo}
                maxLength={12}
              />
            </View>
            {/* guarantor address */}
            <View style={{marginTop: 10, marginBottom: 15}}>
              ...
              <TextInput
                ...
                placeholder=""
                onChangeText={setFirstGrantorAddress}
                value={firstGrantorAddress}
              />
            </View>
          </View>
          ...
          <View
            ...
            <View style={{marginTop: 10}}>
              ...
              <TextInput
                ...
                placeholder="Name"
                onChangeText={setSecondGrantorName}
                value={secondGrantorName}
              />
            </View>
            {/* guarantor S/O, D/O, W/O */}
            <View style={{marginTop: 10}}>
              <Text style={{color: COLORS.green, ...FONTS.body4}}>
                Second Guarantor S/O, D/O, W/O{' '}
                <Text
                  style={{
                    color: COLORS.red,
                    ...FONTS.h4,
              ...
              <TextInput
                ...
                placeholder=""
                onChangeText={setSecondGrantorCareOfName}
                value={secondGrantorCareOfName}
              />
            </View>
            {/* guarantor realtion */}
            <View style={{marginTop: 10}}>
              <Text style={{color: COLORS.green, ...FONTS.body4}}>
                Second Guarantor Relation{' '}
                <Text
                  style={{
                    color: COLORS.red,
                    ...FONTS.h4,
              ...
              <TextInput
                ...
                placeholder=""
                onChangeText={setSecondGrantorRelation}
                value={secondGrantorRelation}
              />
            </View>
            {/* guarantor Aadhar */}
            <View style={{marginTop: 10}}>
              <Text style={{color: COLORS.green, ...FONTS.body4}}>
                Second Guarantor Aadhar Number{' '}
                <Text
                  style={{
                    color: COLORS.red,
                    ...FONTS.h4,
              ...
              <TextInput
                ...
                placeholder=""
                keyboardType="number-pad"
                onChangeText={setSecondGrantorAadhaarNo}
                value={secondGrantorAadhaarNo}
                maxLength={12}
              />
            </View>
            ...
            <View style={{marginTop: 10, marginBottom: 15}}>
              ...
              <TextInput
                ...
                placeholder=""
                onChangeText={setSecondGrantorAddress}
                value={secondGrantorAddress}
              />
            </View>
          </View>
          ...
          {approvalFlag !== 'A' ? (
            <TouchableOpacity
              onPress={() =>
                filledDetails.FIRST_GURANTR_AADHAR_NO == null
                  ? validation('A')
                  : validation('E')
              }>
              <LinearGradient
