...
const ContactBottomView = ({ filledDetails }) => {
    ...
    const saveContactDetails = async () => {
        try {
            if (ValidateForm()) {
                let contactData = { txnId: "", operFlag: "C", candidateId: userId, userId: userId, personalEmailId: personalMail, alternateEmailId: alternateMail, phoneNo: phone, alternatePhoneNo: alternatePhone }
