      ...
      {loaderVisible ? (
        ...
        <KeyboardAwareScrollView
          ...
          <TextInput
            style={[
              styles.inputHolder,
              {marginVertical: 3, marginHorizontal: 7, color: COLORS.black},
            ]}
            value={personalMail}
            onChangeText={val => setPersonalMail(val)}
          ...
          <TextInput
            ...
            value={alternateMail}
            onChangeText={val => setAlternateMail(val)}
            keyboardType="email-address"
            maxLength={100}
          />
          <Text
            ...
            Phone No.<Text style={{color: 'red', fontWeight: 500}}>*</Text>
          </Text>
          <TextInput
            style={[
              styles.inputHolder,
          ...
          <TextInput
            ...
            onChangeText={val => setAlternatePhone(val)}
            maxLength={10}
          />
          {approvalFlag !== 'A' ? (
            <TouchableOpacity
              onPress={() =>
                filledDetails?.PHONE_NO
                  ? saveContactDetails('I')
                  : saveContactDetails('C')
              }>
              <LinearGradient
