        ...
        if (ValidateForm()) {
            ...
            try {
                let PersonalData = {
                    ...
                    actualBirthDate: selectedActualBirthDate,
                    recordBirthDate: selectedRecordBirthDate,
                    birthCountry: countryBirth,
                    birthPlace: placeBirth,
                    identificationMarks: identityMarks,
                    ...
                    refEmailId: refEmail,
                    refContactNo: refContact,
                    refName: refName,
                    refOccupation: refOccupation,
                    refAddress: refAddress,
                    refEmailId1: refEmail1,
                    refContactNo1: refContact1,
                    refName1: refName1,
                    refOccupation1: refOccupation1,
                    refAddress1: refAddress1,
                    operFlag: operFlag,
                    candidateId: userId,
                    userId: userId,
                    motherName: canMotherName
                };
                ...
                <KeyboardAwareScrollView
                    ...
                    <View
                        ...
                        <View style={{ width: '48%', paddingHorizontal: 3 }}>
                            ...
                            <SelectDropdown defaultValue={salutation} data={salutationList} buttonStyle={[styles.inputHolder,{width:'100%'}]} onSelect={(selectedItem, index) => { setSalutation(selectedItem) }} defaultButtonText={"Select"} buttonTextStyle={{ fontSize: 15, color: COLORS.gray }} />
                        </View>
                        <View
                            style={{
                                width: '48%',
