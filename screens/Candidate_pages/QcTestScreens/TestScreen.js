...
const TestScreen = props => {
  ...
  const {questionList, saveTestResult, testResultLoading} = useSelector(
    state => state.eSign,
  );
      ...
      {loaderVisible ? (
        ...
        <View
          ...
          <View
            ...
            {currentIndex + 1 < questionList.length && renderNextButton()}
            {currentIndex + 1 === questionList.length && renderDoneButton()}
          </View>
        </View>
      )}
    </View>
