...
const TestResult = props => {
  ...
  const {candidateId, candidateName, candidateRole} = useSelector(
          ...
          <>
            ...
            <View
              ...
              <View
                ...
                <Text
                  style={{color: COLORS.black, ...FONTS.h4, marginLeft: 10}}>
                  Id:- {candidateId}
                </Text>
                ...
                <Text
                  style={{color: COLORS.black, ...FONTS.h4, marginRight: 10}}>
                  Post:- {candidateRole}
                </Text>
              </View>
              <View
                ...
                <View>
                  ...
                  <View
                    ...
                    <Text style={{color: COLORS.darkGray2, ...FONTS.h5}}>
                      {saveTestResult?.Table[0]?.TEST_RESULT}
                    </Text>
                  </View>
                </View>
                ...
                <View>
                  <View
                    ...
                    <Text style={{color: COLORS.darkGray2, ...FONTS.h5}}>
                      {saveTestResult?.Table[0]?.CORRECT_ANSWER}
                    </Text>
                  </View>
                  <View
                    style={{
                    ...
                    <Text style={{color: COLORS.darkGray2, ...FONTS.h5}}>
                      {saveTestResult?.Table[0]?.WRONG_ANSWER}
                    </Text>
                  </View>
                </View>
              </View>
                ...
                return (
                  <View
                    ...
                    <View
                      ...
                      <LinearGradient
                        style={{padding: 8, borderRadius: 4, marginTop: 10}}
                        start={{x: 0, y: 0}}
                        end={{x: 1, y: 0}}
