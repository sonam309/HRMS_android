...
const ForgetPassword = props => {
  ...
  const getType = async () => {
    page = await AsyncStorage.getItem('type');
    {
      page
        ? page === 'employee'
          ? [setURL(`${API}/api/User/login`), setOper('R')]
          : [setURL(`${API}/api/User/candidateLogin`), setOper('F')]
        : null;
      ...
      <View style={{flex: 1, justifyContent: 'center'}}>
        ...
        {type === 'N' || type === 'F' ? (
          <View>
            ...
            <Text style={styles.enterMpinTxt}>Enter Quick Pin</Text>
            ...
            <View
              ...
              <TextInput
                ...
                style={[
                  styles.txtbox,
                  {borderColor: f1.length >= 1 ? '#F99417' : '#220046'},
                ]}
              ...
              <TextInput
                ...
                style={[
                  styles.txtbox,
                  {borderColor: f2.length >= 1 ? '#F99417' : '#220046'},
                ]}
                keyboardType="number-pad"
                maxLength={1}
                value={f2}
              ...
              <TextInput
                ...
                style={[
                  styles.txtbox,
                  {borderColor: f3.length >= 1 ? '#F99417' : '#220046'},
                ]}
                keyboardType="number-pad"
                maxLength={1}
                value={f3}
              ...
              <TextInput
                ...
                style={[
                  styles.txtbox,
                  {borderColor: f4.length >= 1 ? '#F99417' : '#220046'},
                ]}
                keyboardType="number-pad"
                maxLength={1}
                value={f4}
            ...
            <Text style={styles.confirmMpintxt}>Confirm Quick Pin</Text>
            ...
            <View
              ...
              <TextInput
                ...
                style={[
                  styles.txtbox,
                  {borderColor: f5.length >= 1 ? '#F99417' : '#220046'},
                ]}
                keyboardType="number-pad"
                maxLength={1}
                value={f5}
              ...
              <TextInput
                ...
                style={[
                  styles.txtbox,
                  {borderColor: f6.length >= 1 ? '#F99417' : '#220046'},
                ]}
                keyboardType="number-pad"
                maxLength={1}
                value={f6}
              ...
              <TextInput
                ...
                style={[
                  styles.txtbox,
                  {borderColor: f7.length >= 1 ? '#F99417' : '#220046'},
                ]}
                keyboardType="number-pad"
                maxLength={1}
                value={f7}
              ...
              <TextInput
                ...
                style={[
                  styles.txtbox,
                  {borderColor: f8.length >= 1 ? '#F99417' : '#220046'},
                ]}
                keyboardType="number-pad"
                maxLength={1}
                value={f8}
            ...
            <View style={styles.Message}>
              <Text
                ...
                Once the Quick Pin is successfully changed, you will need to
                login again
              </Text>
            </View>
          </View>
          ...
          <View>
            ...
            <View style={styles.textInputBox}>
              ...
              <CustomPasswordInput
                ...
                value={newPassword}
                onChangeText={security => setnewPassword(security)}
              />
              <AntDesign
                name="eye"
                onPress={changeVisibilitynew}
            ...
            <View style={[styles.textInputBox]}>
              ...
              <CustomPasswordInput
                ...
                onChangeText={security => setConfirmPassword(security)}
              />
              <AntDesign
                name="eye"
                onPress={changeVisibilityConfirm}
                style={{position: 'absolute', right: 9}}
                size={22}
              />
            </View>
            ...
            <View style={styles.Message}>
              <Text
                ...
                Once the password successfully changed, you will need to login
                again
              </Text>
            </View>
          </View>
