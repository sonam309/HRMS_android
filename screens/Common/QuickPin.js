...
const QuickPin = props => {
  ...
  const LoginWithMpin = () => {
    ...
    axios.post(`${API}/api/User/login`, userData).then(response => {
      ...
      // console.warn(result);
      result[0] === 'S'
        ? props.navigation.navigate('Employee_page', {full_name, userId})
        : Toast.show({
            type: 'error',
    ...
    <View style={styles.container}>
      ...
      <View style={{flex: 1, justifyContent: 'center'}}>
        ...
        <View
          ...
          <TouchableOpacity
            style={[styles.elevation, styles.QuickPinBottomBtn]}
            onPress={() =>
              props.navigation.navigate('CreateMpin', {type: 'N'})
            }>
          ...
          <TouchableOpacity
            style={[styles.elevation, styles.QuickPinBottomBtn]}
            onPress={() =>
              props.navigation.navigate('CreateMpin', {type: 'F'})
            }>
            <Text style={styles.QuickPinBottomBtnText}>Forgot Pin?</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
