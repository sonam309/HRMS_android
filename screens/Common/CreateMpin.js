  ...
  const getOTPMethod = () => {
    ...
    axios
      ...
      .then(response => {
        ...
        result[0] === 'S'
          ? props.navigation.navigate('Otp_Verification', {contact, otp, type})
          : Toast.show({
              type: 'error',
    ...
    <View>
      <View style={styles.Header}>
        <Text style={styles.HeaderText}>
          {' '}
          {type === 'N' ? 'Set New Quick Pin' : 'Forgot Quick Pin'}
        </Text>
      </View>
      ...
      <View style={{height: '100%', width: '100%', justifyContent: 'center'}}>
        ...
        <View style={styles.textInputBox}>
          ...
          <AntDesign
            ...
            style={{position: 'absolute', right: 0, marginRight: 9}}
            size={22}
          />
        </View>
        <TouchableOpacity
          ...
          style={[
            ...
            {
              backgroundColor:
                userName !== '' && password !== '' ? COLORS.green : COLORS.gray,
            },
          ]}
