...
const Rejected = (props) => {
    ...
    const getData = () => {
        axios.post(`https://econnectsatya.com:7033/api/hrms/getMailnotification`, { userId: '10005', operFlag: 'R', notificationCat: notificationCat })
            .then(response => {
    ...
    function ListItems(props) {
        const date = props.applyDate, mail_body = props.mail, approver = props.rejected_by, candidate_ID = props.id, category = props.cat, jobId = props.jobId
