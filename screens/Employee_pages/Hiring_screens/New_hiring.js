...
const New_hiring = props => {
  ...
  const getJobOpening = async () => {
    try {
      ...
      let res = await fetch(
        'https://econnectsatya.com:7033/api/hrms/jobOpeningRequest',
        {
          method: 'POST',
          body: formData,
        },
        ...
        <View
          ...
          <View style={{ justifyContent: 'space-between' }}>
            <View style={{ flexDirection: 'row' }}>
              ...
              {job_status && (
                <Text
                  style={[{ backgroundColor: statusColor }, styles.categoryTag]}>
                  {job_status}
                </Text>
              )}
            </View>
            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              <Text style={{ color: 'black', marginHorizontal: 5 }}>
                <Icons name="account-outline" color={COLORS.gray} size={20} />{' '}
                {positions} Opening
              </Text>
              <Text style={{ color: 'black', marginHorizontal: 5 }}>
                <Icons name="cash" color={COLORS.gray} size={20} />{' '}
                {compensation}
              </Text>
            </View>
            <View
