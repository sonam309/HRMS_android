    ...
    return (
      <View>
        ...
        <View
          ...
          <Text style={{...FONTS.h5, fontSize: 20, color: COLORS.black}}>
            Feedback Request
          </Text>
          {/* Close Button */}
        ...
        <KeyboardAwareScrollView
          ...
          <View style={{marginVertical: 12}}>
            <View style={{}}>
              ...
              {/* Heading */}
              <Text style={{...FONTS.h4, color: COLORS.green, fontSize: 16}}>
                Candidate Rating
              </Text>
            </View>
            ...
            <View style={{paddingVertical: 12}}>
              ...
              <View style={{marginVertical: 12}}>
                ...
                <TextInput
                  value={yourRemarks}
                  onChangeText={text => setYourRemarks(text)}
                  multiline
          ...
          <View
            ...
            <View
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  props.navigation.navigate('Candidate_Resume', {resume})
                }>
                <Icons
              ...
              {saveTestResult?.Result?.[0].FLAG !== 'F' && (
                <View
                  style={{
                    height: 1,
                    width: '95%',
              ...
              {saveTestResult?.Result?.[0].FLAG !== 'F' && (
                <TouchableOpacity
                  style={[styles.resumeArea]}
                  onPress={() =>
                    props.navigation.navigate('CandidateTestResult', {
                      candidateId,
                      name,
                      designation,
                    })
